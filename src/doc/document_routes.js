...
import { createdoc,getMyDocs, getDocById, updateColor,updateTitle, getMetadata, updateMetadata, deleteDoc  } from './document_controller.js';
...
router.delete('/delete',authMiddleware,roleMiddleware([UserRoles.ADMIN,UserRoles.USER]),deleteDoc);
